...
const frontCarousel = () => {
  ...
  <Carousel.Item>
    ...
    <Carousel.Caption>
      ...
      <Button id="grantButton" variant="dark" href="/grant">View Grant Calculator</Button>
    </Carousel.Caption>
  </Carousel.Item>
  <Carousel.Item>
    <img
    ...
    <Carousel.Caption>
      ...
      <Button id="locationButton" variant="dark" href="/location">View Location Calculator</Button>
    </Carousel.Caption>
  </Carousel.Item>
</Carousel>
    )
