    ...
    try {
      ...
      setPsi({
        ...
        setPm25({
          ...
          central:
            response3.data.items[0].readings.pm25_one_hourly.central,
          national:
            response3.data.items[0].readings.pm25_one_hourly.national
        });
        setTemp({
          "Bukit Batok Road, Tengah Park Avenue": response4.data.items[0].readings[6].value,
          "Choa Chu Kang Grove, Keat Hong Link": response4.data.items[0].readings[6].value,
          "Pasir Ris Drive, Pasir Ris Green": response4.data.items[0].readings[12].value,
          "Tampines Street 96, Tampines Street 92": response4.data.items[0].readings[3].value,
